...
export const mockAccounts: Record<string, MockAccount> = {
  "b4by_4ngel__": {
    profile: currentUser,
    posts: [
      { thumbnail: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=300&h=300&fit=crop", videoUrl: "https://streamable.com/owo7oy" },
      ...
      { thumbnail: "https://images.unsplash.com/photo-1501785888041-af3ef285b470?w=300&h=300&fit=crop" },
      { thumbnail: "https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=300&h=300&fit=crop" },
    ],
    highlights: [
      { name: "💕ɢʟᴏᴡᴛʜ-💕", image: "https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=100&h=100&fit=crop" },
      { name: "🌊channel★", image: "https://images.unsplash.com/photo-1492633423870-43d1cd2775ff?w=100&h=100&fit=crop" },
    ],
    storyNote: "Ask friends anything...",
    category: "Dancer",
    channelText: "💕 🚀NANCY🦋WORLD🚀 1,288 members",
    dashboardViews: "11.6K",
    postsDisplay: "82",
    followersDisplay: "38.7K",
    followingDisplay: "8",
  },
  "virat.kohli": {
    profile: {
